...
type SplitHTTPConfig struct {
	...
	ScDownlinkKeepAliveSecs   Int32Range        `json:"scDownlinkKeepAliveSecs"`
	ScDownlinkFlushBytes      Int32Range        `json:"scDownlinkFlushBytes"`
	ScDownlinkFlushDelayMs    Int32Range        `json:"scDownlinkFlushDelayMs"`
	ScDownlinkKeepAliveHeader string            `json:"scDownlinkKeepAliveHeader"`
...
func (c *SplitHTTPConfig) Build() (proto.Message, error) {
	...
	config := &splithttp.Config{
		...
		ScDownlinkKeepAliveSecs:   newRangeConfig(c.ScDownlinkKeepAliveSecs),
		ScDownlinkFlushBytes:      newRangeConfig(c.ScDownlinkFlushBytes),
		ScDownlinkFlushDelayMs:    newRangeConfig(c.ScDownlinkFlushDelayMs),
		ScDownlinkKeepAliveHeader: c.ScDownlinkKeepAliveHeader,
