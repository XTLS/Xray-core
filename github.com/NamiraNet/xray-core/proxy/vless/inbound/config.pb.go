...
const file_proxy_vless_inbound_config_proto_rawDesc = "" +
	...
	"decryption\x12@\n" +
	"\tfallbacks\x18\x03 \x03(\v2\".xray.proxy.vless.inbound.FallbackR\tfallbacksBo\n" +
	"\x1ccom.xray.proxy.vless.inboundP\x01Z2github.com/NamiraNet/xray-core/proxy/vless/inbound\xaa\x02\x18Xray.Proxy.Vless.Inboundb\x06proto3"
