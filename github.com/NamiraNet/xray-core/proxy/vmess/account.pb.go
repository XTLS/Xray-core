...
const file_proxy_vmess_account_proto_rawDesc = "" +
	...
	"\rtests_enabled\x18\x04 \x01(\tR\ftestsEnabledBW\n" +
	"\x14com.xray.proxy.vmessP\x01Z*github.com/NamiraNet/xray-core/proxy/vmess\xaa\x02\x10Xray.Proxy.Vmessb\x06proto3"
