...
const file_proxy_http_config_proto_rawDesc = "" +
	...
	"\x06header\x18\x02 \x03(\v2\x17.xray.proxy.http.HeaderR\x06headerBT\n" +
	"\x13com.xray.proxy.httpP\x01Z)github.com/NamiraNet/xray-core/proxy/http\xaa\x02\x0fXray.Proxy.Httpb\x06proto3"
