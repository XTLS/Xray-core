...
const file_transport_internet_tls_config_proto_rawDesc = "" +
	...
	"\x0fAUTHORITY_ISSUE\x10\x02\"\xea\x06\n" +
	"\x06Config\x12%\n" +
	...
	"\x0fech_config_list\x18\x12 \x01(\tR\rechConfigList\x12&\n" +
	"\x0fech_server_keys\x18\x13 \x01(\fR\rechServerKeysBx\n" +
	"\x1fcom.xray.transport.internet.tlsP\x01Z5github.com/NamiraNet/xray-core/transport/internet/tls\xaa\x02\x1bXray.Transport.Internet.Tlsb\x06proto3"
