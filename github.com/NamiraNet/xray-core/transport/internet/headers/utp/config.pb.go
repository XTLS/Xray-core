...
const file_transport_internet_headers_utp_config_proto_rawDesc = "" +
	...
	"\x06Config\x12\x18\n" +
	"\aversion\x18\x01 \x01(\rR\aversionB\x90\x01\n" +
	"'com.xray.transport.internet.headers.utpP\x01Z=github.com/NamiraNet/xray-core/transport/internet/headers/utp\xaa\x02#Xray.Transport.Internet.Headers.Utpb\x06proto3"
