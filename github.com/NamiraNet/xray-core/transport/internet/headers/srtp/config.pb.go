...
const file_transport_internet_headers_srtp_config_proto_rawDesc = "" +
	...
	"\fpayload_type\x18\x06 \x01(\rR\vpayloadTypeB\x93\x01\n" +
	"(com.xray.transport.internet.headers.srtpP\x01Z>github.com/NamiraNet/xray-core/transport/internet/headers/srtp\xaa\x02$Xray.Transport.Internet.Headers.Srtpb\x06proto3"
