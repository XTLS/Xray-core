...
const file_transport_internet_headers_http_config_proto_rawDesc = "" +
	...
	"\bresponse\x18\x02 \x01(\v24.xray.transport.internet.headers.http.ResponseConfigR\bresponseB\x93\x01\n" +
	"(com.xray.transport.internet.headers.httpP\x01Z>github.com/NamiraNet/xray-core/transport/internet/headers/http\xaa\x02$Xray.Transport.Internet.Headers.Httpb\x06proto3"
