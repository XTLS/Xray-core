...
const file_transport_internet_headers_tls_config_proto_rawDesc = "" +
	...
	"\fPacketConfigB\x90\x01\n" +
	"'com.xray.transport.internet.headers.tlsP\x01Z=github.com/NamiraNet/xray-core/transport/internet/headers/tls\xaa\x02#Xray.Transport.Internet.Headers.Tlsb\x06proto3"
