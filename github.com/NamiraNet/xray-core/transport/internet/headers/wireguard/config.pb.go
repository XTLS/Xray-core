...
const file_transport_internet_headers_wireguard_config_proto_rawDesc = "" +
	...
	"\x0fWireguardConfigB\xa2\x01\n" +
	"-com.xray.transport.internet.headers.wireguardP\x01ZCgithub.com/NamiraNet/xray-core/transport/internet/headers/wireguard\xaa\x02)Xray.Transport.Internet.Headers.Wireguardb\x06proto3"
