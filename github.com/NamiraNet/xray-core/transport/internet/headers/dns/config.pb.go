...
const file_transport_internet_headers_dns_config_proto_rawDesc = "" +
	...
	"\x06Config\x12\x16\n" +
	"\x06domain\x18\x01 \x01(\tR\x06domainB\x90\x01\n" +
	"'com.xray.transport.internet.headers.dnsP\x01Z=github.com/NamiraNet/xray-core/transport/internet/headers/dns\xaa\x02#Xray.Transport.Internet.Headers.DNSb\x06proto3"
