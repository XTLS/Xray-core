...
import (
	...
	proxy "github.com/xtls/xray-core/proxy"
...
type ServerConfig struct {
	...
	Fallbacks []*proxy.Fallback `protobuf:"bytes,2,rep,name=fallbacks,proto3" json:"fallbacks,omitempty"`
}
...
func (x *ServerConfig) GetFallbacks() []*proxy.Fallback {
	if x != nil {
		return x.Fallbacks
	}
	return nil
...
var file_proxy_trojan_config_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x5f, 0x73, 0x70, 0x65, 0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x14, 0x70,
	0x72, 0x6f, 0x78, 0x79, 0x2f, 0x66, 0x61, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x2e, 0x70, 0x72,
	...
	0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x4c, 0x0a, 0x0c, 0x43, 0x6c,
	0x69, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x3c, 0x0a, 0x06, 0x73, 0x65,
	0x72, 0x76, 0x65, 0x72, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x78, 0x72, 0x61,
	...
	0x52, 0x06, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x22, 0x74, 0x0a, 0x0c, 0x53, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x30, 0x0a, 0x05, 0x75, 0x73, 0x65, 0x72,
	...
	0x73, 0x65, 0x72, 0x52, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x12, 0x32, 0x0a, 0x09, 0x66, 0x61,
	0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e,
	0x78, 0x72, 0x61, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x2e, 0x46, 0x61, 0x6c, 0x6c, 0x62,
	0x61, 0x63, 0x6b, 0x52, 0x09, 0x66, 0x61, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x73, 0x42, 0x55,
	0x0a, 0x15, 0x63, 0x6f, 0x6d, 0x2e, 0x78, 0x72, 0x61, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x78, 0x79,
	0x2e, 0x74, 0x72, 0x6f, 0x6a, 0x61, 0x6e, 0x50, 0x01, 0x5a, 0x26, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_proxy_trojan_config_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proxy_trojan_config_proto_goTypes = []interface{}{
	(*Account)(nil),                 // 0: xray.proxy.trojan.Account
	(*ClientConfig)(nil),            // 1: xray.proxy.trojan.ClientConfig
	(*ServerConfig)(nil),            // 2: xray.proxy.trojan.ServerConfig
	(*protocol.ServerEndpoint)(nil), // 3: xray.common.protocol.ServerEndpoint
	(*protocol.User)(nil),           // 4: xray.common.protocol.User
	(*proxy.Fallback)(nil),          // 5: xray.proxy.Fallback
}
var file_proxy_trojan_config_proto_depIdxs = []int32{
	3, // 0: xray.proxy.trojan.ClientConfig.server:type_name -> xray.common.protocol.ServerEndpoint
	4, // 1: xray.proxy.trojan.ServerConfig.users:type_name -> xray.common.protocol.User
	5, // 2: xray.proxy.trojan.ServerConfig.fallbacks:type_name -> xray.proxy.Fallback
