...
type Config struct {
	...
	DnsMode       string   `protobuf:"bytes,12,opt,name=dns_mode,json=dnsMode,proto3" json:"dns_mode,omitempty"`
	DnsAddress    []string `protobuf:"bytes,13,rep,name=dns_address,json=dnsAddress,proto3" json:"dns_address,omitempty"`
	StrictRoute   bool     `protobuf:"varint,14,opt,name=strict_route,json=strictRoute,proto3" json:"strict_route,omitempty"`
...
func (x *Config) GetDnsMode() string {
	if x != nil {
		return x.DnsMode
	}
	return ""
...
func (x *Config) GetDnsAddress() []string {
	if x != nil {
		return x.DnsAddress
	}
	return nil
...
const file_proxy_tun_config_proto_rawDesc = "" +
	"\n" +
	"\x16proxy/tun/config.proto\x12\x0exray.proxy.tun\"\xfd\x02\n" +
	"\x06Config\x12\x12\n" +
	...
	"\x18auto_outbounds_interface\x18\a \x01(\tR\x16autoOutboundsInterface\x12\x14\n" +
	"\x05stack\x18\n" +
	" \x01(\tR\x05stack\x12\x18\n" +
	"\aaddress\x18\v \x03(\tR\aaddress\x12\x19\n" +
	"\bdns_mode\x18\f \x01(\tR\adnsMode\x12\x1f\n" +
	"\vdns_address\x18\r \x03(\tR\n" +
	"dnsAddress\x12!\n" +
	"\fstrict_route\x18\x0e \x01(\bR\vstrictRouteBL\n" +
