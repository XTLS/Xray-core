...
type ClientConfig struct {
	...
	Udpraw        bool                     `protobuf:"varint,3,opt,name=udpraw,proto3" json:"udpraw,omitempty"`
...
func (x *ClientConfig) GetUdpraw() bool {
	if x != nil {
		return x.Udpraw
	}
	return false
...
type ServerConfig struct {
	...
	Udpraw        bool                   `protobuf:"varint,2,opt,name=udpraw,proto3" json:"udpraw,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ServerConfig) GetUdpraw() bool {
	if x != nil {
		return x.Udpraw
	}
	return false
...
const file_proxy_hysteria_config_proto_rawDesc = "" +
	"\n" +
	"\x1bproxy/hysteria/config.proto\x12\x13xray.proxy.hysteria\x1a!common/protocol/server_spec.proto\x1a\x1acommon/protocol/user.proto\"~\n" +
	"\fClientConfig\x12\x18\n" +
	"\aversion\x18\x01 \x01(\x05R\aversion\x12<\n" +
	"\x06server\x18\x02 \x01(\v2$.xray.common.protocol.ServerEndpointR\x06server\x12\x16\n" +
	"\x06udpraw\x18\x03 \x01(\bR\x06udpraw\"X\n" +
	"\fServerConfig\x120\n" +
	"\x05users\x18\x01 \x03(\v2\x1a.xray.common.protocol.UserR\x05users\x12\x16\n" +
	"\x06udpraw\x18\x02 \x01(\bR\x06udprawB[\n" +
