...
func TestPluralAggregate(t *testing.T) {
	slice := []error{fmt.Errorf("abc"), fmt.Errorf("123")}
	var agg Aggregate
	var err error
...
func TestDedupeAggregate(t *testing.T) {
	slice := []error{fmt.Errorf("abc"), fmt.Errorf("abc")}
	var agg Aggregate
...
func TestDedupePluralAggregate(t *testing.T) {
	slice := []error{fmt.Errorf("abc"), fmt.Errorf("abc"), fmt.Errorf("123")}
	var agg Aggregate
...
func TestFlattenAndDedupeAggregate(t *testing.T) {
	slice := []error{fmt.Errorf("abc"), fmt.Errorf("abc"), NewAggregate([]error{fmt.Errorf("abc")})}
	var agg Aggregate
...
func TestFlattenAggregate(t *testing.T) {
	slice := []error{fmt.Errorf("abc"), fmt.Errorf("abc"), NewAggregate([]error{fmt.Errorf("abc"), fmt.Errorf("def"), NewAggregate([]error{fmt.Errorf("def"), fmt.Errorf("ghi")})})}
	var agg Aggregate
