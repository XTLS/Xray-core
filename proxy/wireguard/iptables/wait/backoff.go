...
import (
	...
	"github.com/xtls/xray-core/proxy/wireguard/iptables/wait/clock"
)
...
func delay(steps int, duration, cap time.Duration, factor, jitter float64) (_, next time.Duration, nextSteps int) {
