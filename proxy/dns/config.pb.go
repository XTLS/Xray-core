...
type Config struct {
	...
	ToServer      *net.Endpoint          `protobuf:"bytes,3,opt,name=to_server,json=toServer,proto3" json:"to_server,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Config) GetToServer() *net.Endpoint {
	if x != nil {
		return x.ToServer
	}
	return nil
...
const file_proxy_dns_config_proto_rawDesc = "" +
	...
	"\x06domain\x18\x03 \x03(\v2\x1f.xray.common.geodata.DomainRuleR\x06domain\"\x92\x01\n" +
	"\x06Config\x12\x1d\n" +
	"\n" +
	"user_level\x18\x01 \x01(\rR\tuserLevel\x121\n" +
	"\x04rule\x18\x02 \x03(\v2\x1d.xray.proxy.dns.DNSRuleConfigR\x04rule\x126\n" +
	"\tto_server\x18\x03 \x01(\v2\x19.xray.common.net.EndpointR\btoServer*:\n" +
	"\n" +
	"RuleAction\x12\n" +
	"\n" +
...
var file_proxy_dns_config_proto_depIdxs = []int32{
	...
	4, // 3: xray.proxy.dns.Config.to_server:type_name -> xray.common.net.Endpoint
