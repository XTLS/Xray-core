...
type Config struct {
	...
	Noise               []*Noise              `protobuf:"bytes,6,rep,name=noise,proto3" json:"noise,omitempty"`
}
...
var file_proxy_freedom_config_proto_rawDesc = []byte{
	...
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x78, 0x72, 0x61, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x78,
