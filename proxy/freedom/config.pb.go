...
func (Config_DomainStrategy) Descriptor() protoreflect.EnumDescriptor {
	return file_common_protocol_freedom_config_proto_enumTypes[0].Descriptor()
}

func (Config_DomainStrategy) Type() protoreflect.EnumType {
	return &file_common_protocol_freedom_config_proto_enumTypes[0]
}
...
func (Config_DomainStrategy) EnumDescriptor() ([]byte, []int) {
	return file_common_protocol_freedom_config_proto_rawDescGZIP(), []int{2, 0}
}
...
func (x *DestinationOverride) Reset() {
	*x = DestinationOverride{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_protocol_freedom_config_proto_msgTypes[0]
...
func (*DestinationOverride) Descriptor() ([]byte, []int) {
	return file_common_protocol_freedom_config_proto_rawDescGZIP(), []int{0}
}
...
func (x *Fragment) Reset() {
	*x = Fragment{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_protocol_freedom_config_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Fragment) Descriptor() ([]byte, []int) {
	return file_common_protocol_freedom_config_proto_rawDescGZIP(), []int{1}
}
...
type Config struct {
	...
	// Deprecated: Marked as deprecated in common/protocol/freedom/config.proto.
...
func (x *Config) Reset() {
	*x = Config{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_protocol_freedom_config_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Config) Descriptor() ([]byte, []int) {
	return file_common_protocol_freedom_config_proto_rawDescGZIP(), []int{2}
}
...
var File_common_protocol_freedom_config_proto protoreflect.FileDescriptor
...
var (
	file_common_protocol_freedom_config_proto_rawDescOnce sync.Once
	file_common_protocol_freedom_config_proto_rawDescData = file_common_protocol_freedom_config_proto_rawDesc
)

func file_common_protocol_freedom_config_proto_rawDescGZIP() []byte {
	file_common_protocol_freedom_config_proto_rawDescOnce.Do(func() {
		file_common_protocol_freedom_config_proto_rawDescData = protoimpl.X.CompressGZIP(file_common_protocol_freedom_config_proto_rawDescData)
	})
	return file_common_protocol_freedom_config_proto_rawDescData
}

var file_common_protocol_freedom_config_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_common_protocol_freedom_config_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_common_protocol_freedom_config_proto_goTypes = []interface{}{
...
var file_common_protocol_freedom_config_proto_depIdxs = []int32{
...
func init() { file_common_protocol_freedom_config_proto_init() }
func file_common_protocol_freedom_config_proto_init() {
	if File_common_protocol_freedom_config_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_common_protocol_freedom_config_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_common_protocol_freedom_config_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_common_protocol_freedom_config_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Config); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_common_protocol_freedom_config_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_protocol_freedom_config_proto_goTypes,
		DependencyIndexes: file_common_protocol_freedom_config_proto_depIdxs,
		EnumInfos:         file_common_protocol_freedom_config_proto_enumTypes,
		MessageInfos:      file_common_protocol_freedom_config_proto_msgTypes,
	}.Build()
	File_common_protocol_freedom_config_proto = out.File
	file_common_protocol_freedom_config_proto_rawDesc = nil
	file_common_protocol_freedom_config_proto_goTypes = nil
	file_common_protocol_freedom_config_proto_depIdxs = nil
}
