...
type Config struct {
	...
	ErrorStderr   bool                   `protobuf:"varint,8,opt,name=error_stderr,json=errorStderr,proto3" json:"error_stderr,omitempty"`
	MinSeverity   log.Severity           `protobuf:"varint,9,opt,name=min_severity,json=minSeverity,proto3,enum=xray.common.log.Severity" json:"min_severity,omitempty"`
...
func (x *Config) GetErrorStderr() bool {
	if x != nil {
		return x.ErrorStderr
	}
	return false
}

func (x *Config) GetMinSeverity() log.Severity {
	if x != nil {
...
const file_app_log_config_proto_rawDesc = "" +
	"\n" +
	"\x14app/log/config.proto\x12\fxray.app.log\x1a\x14common/log/log.proto\"\xbf\x03\n" +
	"\x06Config\x12;\n" +
	...
	"\ferror_stderr\x18\b \x01(\bR\verrorStderr\x12<\n" +
	"\fmin_severity\x18\t \x01(\x0e2\x19.xray.common.log.SeverityR\vminSeverity*5\n" +
	"\aLogType\x12\b\n" +
...
var file_app_log_config_proto_depIdxs = []int32{
	...
	2, // 3: xray.app.log.Config.min_severity:type_name -> xray.common.log.Severity
