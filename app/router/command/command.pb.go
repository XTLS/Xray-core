...
type AddRuleRequest struct {
	...
	// Zero-based insertion position. When set, rules are inserted before the
	// rule currently at this index. An index equal to the rule count appends.
...
func (x *AddRuleRequest) GetIndex() uint32 {
...
type RemoveRuleRequest struct {
	...
	// Zero-based index of the rule to remove. Mutually exclusive with ruleTag.
...
func (x *RemoveRuleRequest) GetIndex() uint32 {
	if x != nil && x.Index != nil {
		return *x.Index
	}
	return 0
...
type ListRuleItem struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Zero-based rule evaluation order. The first matching rule is used.
	Index *uint32 `protobuf:"varint,1,opt,name=index,proto3,oneof" json:"index,omitempty"`
	// Complete, original routing rule configuration.
	Rule          *router.RoutingRule `protobuf:"bytes,2,opt,name=rule,proto3" json:"rule,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListRuleItem) GetIndex() uint32 {
	if x != nil && x.Index != nil {
		return *x.Index
	}
	return 0
...
const file_app_router_command_command_proto_rawDesc = "" +
	...
	"\x1eOverrideBalancerTargetResponse\"\x93\x01\n" +
	"\x0eAddRuleRequest\x128\n" +
	"\x06config\x18\x01 \x01(\v2 .xray.common.serial.TypedMessageR\x06config\x12\"\n" +
	"\fshouldAppend\x18\x02 \x01(\bR\fshouldAppend\x12\x19\n" +
	"\x05index\x18\x03 \x01(\rH\x00R\x05index\x88\x01\x01B\b\n" +
	"\x06_index\"\x11\n" +
	"\x0fAddRuleResponse\"R\n" +
	"\x11RemoveRuleRequest\x12\x18\n" +
	"\aruleTag\x18\x01 \x01(\tR\aruleTag\x12\x19\n" +
	"\x05index\x18\x02 \x01(\rH\x00R\x05index\x88\x01\x01B\b\n" +
	"\x06_index\"\x14\n" +
	"\x12RemoveRuleResponse\"\x11\n" +
	"\x0fListRuleRequest\"e\n" +
	"\fListRuleItem\x12\x19\n" +
	"\x05index\x18\x01 \x01(\rH\x00R\x05index\x88\x01\x01\x120\n" +
	"\x04rule\x18\x02 \x01(\v2\x1c.xray.app.router.RoutingRuleR\x04ruleB\b\n" +
	"\x06_index\"O\n" +
...
func file_app_router_command_command_proto_init() {
	...
	file_app_router_command_command_proto_msgTypes[10].OneofWrappers = []any{}
	file_app_router_command_command_proto_msgTypes[12].OneofWrappers = []any{}
	file_app_router_command_command_proto_msgTypes[15].OneofWrappers = []any{}
	type x struct{}
