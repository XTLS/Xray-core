...
type RoutingContext struct {
	...
	Restriction       *route.Restriction     `protobuf:"bytes,13,opt,name=Restriction,proto3" json:"Restriction,omitempty"`
...
func (x *RoutingContext) GetRestriction() *route.Restriction {
	if x != nil {
...
const file_app_router_command_command_proto_rawDesc = "" +
	"\n" +
	" app/router/command/command.proto\x12\x17xray.app.router.command\x1a\x18common/net/network.proto\x1a!common/serial/typed_message.proto\x1a\x1acommon/route/routing.proto\"\xde\x04\n" +
	...
	"\vOutboundTag\x18\f \x01(\tR\vOutboundTag\x12@\n" +
	"\vRestriction\x18\r \x01(\v2\x1e.xray.common.route.RestrictionR\vRestriction\x1a=\n" +
...
var file_app_router_command_command_proto_depIdxs = []int32{
	...
	17, // 2: xray.app.router.command.RoutingContext.Restriction:type_name -> xray.common.route.Restriction
	0,  // 3: xray.app.router.command.TestRouteRequest.RoutingContext:type_name -> xray.app.router.command.RoutingContext
	4,  // 4: xray.app.router.command.BalancerMsg.override:type_name -> xray.app.router.command.OverrideInfo
	3,  // 5: xray.app.router.command.BalancerMsg.principle_target:type_name -> xray.app.router.command.PrincipleTargetInfo
	5,  // 6: xray.app.router.command.GetBalancerInfoResponse.balancer:type_name -> xray.app.router.command.BalancerMsg
	18, // 7: xray.app.router.command.AddRuleRequest.config:type_name -> xray.common.serial.TypedMessage
	...
	0,  // 14: xray.app.router.command.RoutingService.SubscribeRoutingStats:output_type -> xray.app.router.command.RoutingContext
	0,  // 15: xray.app.router.command.RoutingService.TestRoute:output_type -> xray.app.router.command.RoutingContext
	7,  // 16: xray.app.router.command.RoutingService.GetBalancerInfo:output_type -> xray.app.router.command.GetBalancerInfoResponse
	9,  // 17: xray.app.router.command.RoutingService.OverrideBalancerTarget:output_type -> xray.app.router.command.OverrideBalancerTargetResponse
	11, // 18: xray.app.router.command.RoutingService.AddRule:output_type -> xray.app.router.command.AddRuleResponse
	13, // 19: xray.app.router.command.RoutingService.RemoveRule:output_type -> xray.app.router.command.RemoveRuleResponse
