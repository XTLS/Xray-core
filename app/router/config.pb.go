...
type RoutingRule struct {
	...
	// Matches only after an asynchronously populated shared DNS route cache
	// classifies the target domain as RU. A cache miss never blocks routing.
	AsyncDnsRoute *AsyncDnsRouteConfig `protobuf:"bytes,24,opt,name=async_dns_route,json=asyncDnsRoute,proto3" json:"async_dns_route,omitempty"`
...
func (x *RoutingRule) GetAsyncDnsRoute() *AsyncDnsRouteConfig {
	if x != nil {
		return x.AsyncDnsRoute
	}
	return nil
}
...
type AsyncDnsRouteConfig struct {
	...
	RequestTimeoutMillis uint32                 `protobuf:"varint,2,opt,name=request_timeout_millis,json=requestTimeoutMillis,proto3" json:"request_timeout_millis,omitempty"`
	CacheCapacity        uint32                 `protobuf:"varint,3,opt,name=cache_capacity,json=cacheCapacity,proto3" json:"cache_capacity,omitempty"`
	...
	MinTtlMillis         uint32                 `protobuf:"varint,6,opt,name=min_ttl_millis,json=minTtlMillis,proto3" json:"min_ttl_millis,omitempty"`
...
func (x *AsyncDnsRouteConfig) Reset() {
	*x = AsyncDnsRouteConfig{}
	mi := &file_app_router_config_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AsyncDnsRouteConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AsyncDnsRouteConfig) ProtoMessage() {}

func (x *AsyncDnsRouteConfig) ProtoReflect() protoreflect.Message {
	mi := &file_app_router_config_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AsyncDnsRouteConfig.ProtoReflect.Descriptor instead.
func (*AsyncDnsRouteConfig) Descriptor() ([]byte, []int) {
	return file_app_router_config_proto_rawDescGZIP(), []int{1}
}

func (x *AsyncDnsRouteConfig) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
func (x *AsyncDnsRouteConfig) GetRequestTimeoutMillis() uint32 {
	if x != nil {
...
func (x *AsyncDnsRouteConfig) GetCacheCapacity() uint32 {
	if x != nil {
...
func (x *AsyncDnsRouteConfig) GetQueueCapacity() uint32 {
	if x != nil {
...
func (x *AsyncDnsRouteConfig) GetWorkers() uint32 {
	if x != nil {
		return x.Workers
	}
	return 0
...
func (x *AsyncDnsRouteConfig) GetMinTtlMillis() uint32 {
	if x != nil {
		return x.MinTtlMillis
	}
	return 0
}

func (x *AsyncDnsRouteConfig) GetMaxTtlMillis() uint32 {
	if x != nil {
		return x.MaxTtlMillis
	}
	return 0
}
...
const file_app_router_config_proto_rawDesc = "" +
	"\n" +
	"\x17app/router/config.proto\x12\x0fxray.app.router\x1a!common/serial/typed_message.proto\x1a\x15common/net/port.proto\x1a\x18common/net/network.proto\x1a\x1bcommon/geodata/geodat.proto\"\xaa\b\n" +
	...
	"\blocal_os\x18\x17 \x03(\tR\alocalOs\x12L\n" +
	"\x0fasync_dns_route\x18\x18 \x01(\v2$.xray.app.router.AsyncDnsRouteConfigR\rasyncDnsRoute\x1a=\n" +
	...
	"\x0ecache_capacity\x18\x03 \x01(\rR\rcacheCapacity\x12%\n" +
	"\x0equeue_capacity\x18\x04 \x01(\rR\rqueueCapacity\x12\x18\n" +
	"\aworkers\x18\x05 \x01(\rR\aworkers\x12$\n" +
	"\x0emin_ttl_millis\x18\x06 \x01(\rR\fminTtlMillis\x12$\n" +
	"\x0emax_ttl_millis\x18\a \x01(\rR\fmaxTtlMillis\"\xca\x01\n" +
...
var file_app_router_config_proto_goTypes = []any{
	...
	(*AsyncDnsRouteConfig)(nil),     // 2: xray.app.router.AsyncDnsRouteConfig
	(*WebhookConfig)(nil),           // 3: xray.app.router.WebhookConfig
	(*BalancingRule)(nil),           // 4: xray.app.router.BalancingRule
	(*StrategyWeight)(nil),          // 5: xray.app.router.StrategyWeight
	(*StrategyLeastLoadConfig)(nil), // 6: xray.app.router.StrategyLeastLoadConfig
...
var file_app_router_config_proto_depIdxs = []int32{
	...
	3,  // 10: xray.app.router.RoutingRule.webhook:type_name -> xray.app.router.WebhookConfig
	2,  // 11: xray.app.router.RoutingRule.async_dns_route:type_name -> xray.app.router.AsyncDnsRouteConfig
	9,  // 12: xray.app.router.WebhookConfig.headers:type_name -> xray.app.router.WebhookConfig.HeadersEntry
	14, // 13: xray.app.router.BalancingRule.strategy_settings:type_name -> xray.common.serial.TypedMessage
	5,  // 14: xray.app.router.StrategyLeastLoadConfig.costs:type_name -> xray.app.router.StrategyWeight
	...
	4,  // 17: xray.app.router.Config.balancing_rule:type_name -> xray.app.router.BalancingRule
