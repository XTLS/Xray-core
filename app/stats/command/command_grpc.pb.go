...
const (
	...
	StatsService_GetOnlineUsersByInbound_FullMethodName = "/xray.app.stats.command.StatsService/GetOnlineUsersByInbound"
)
...
type StatsServiceClient interface {
	...
	GetOnlineUsersByInbound(ctx context.Context, in *GetOnlineUsersByInboundRequest, opts ...grpc.CallOption) (*GetOnlineUsersByInboundResponse, error)
}
...
func (c *statsServiceClient) GetOnlineUsersByInbound(ctx context.Context, in *GetOnlineUsersByInboundRequest, opts ...grpc.CallOption) (*GetOnlineUsersByInboundResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetOnlineUsersByInboundResponse)
	err := c.cc.Invoke(ctx, StatsService_GetOnlineUsersByInbound_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StatsServiceServer interface {
	...
	GetOnlineUsersByInbound(context.Context, *GetOnlineUsersByInboundRequest) (*GetOnlineUsersByInboundResponse, error)
...
func (UnimplementedStatsServiceServer) GetOnlineUsersByInbound(context.Context, *GetOnlineUsersByInboundRequest) (*GetOnlineUsersByInboundResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetOnlineUsersByInbound not implemented")
}
...
func _StatsService_GetOnlineUsersByInbound_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetOnlineUsersByInboundRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StatsServiceServer).GetOnlineUsersByInbound(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StatsService_GetOnlineUsersByInbound_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatsServiceServer).GetOnlineUsersByInbound(ctx, req.(*GetOnlineUsersByInboundRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var StatsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetOnlineUsersByInbound",
			Handler:    _StatsService_GetOnlineUsersByInbound_Handler,
		},
	},
