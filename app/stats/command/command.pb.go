...
type GetStatsOnlineIpListResponse struct {
	...
	Name string            `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Ips  map[string]uint64 `protobuf:"bytes,2,rep,name=ips,proto3" json:"ips,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func (x *GetStatsOnlineIpListResponse) GetIps() map[string]uint64 {
	if x != nil {
		return x.Ips
	}
	return nil
