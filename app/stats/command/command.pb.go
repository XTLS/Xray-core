...
type OnlineUserByInbound struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	InboundTag    string                 `protobuf:"bytes,1,opt,name=inbound_tag,json=inboundTag,proto3" json:"inbound_tag,omitempty"`
	Email         string                 `protobuf:"bytes,2,opt,name=email,proto3" json:"email,omitempty"`
	Ips           []*OnlineIPEntry       `protobuf:"bytes,3,rep,name=ips,proto3" json:"ips,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *OnlineUserByInbound) Reset() {
	*x = OnlineUserByInbound{}
	mi := &file_app_stats_command_command_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *OnlineUserByInbound) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OnlineUserByInbound) ProtoMessage() {}

func (x *OnlineUserByInbound) ProtoReflect() protoreflect.Message {
	mi := &file_app_stats_command_command_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OnlineUserByInbound.ProtoReflect.Descriptor instead.
func (*OnlineUserByInbound) Descriptor() ([]byte, []int) {
	return file_app_stats_command_command_proto_rawDescGZIP(), []int{13}
}

func (x *OnlineUserByInbound) GetInboundTag() string {
	if x != nil {
		return x.InboundTag
	}
	return ""
...
func (x *OnlineUserByInbound) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *OnlineUserByInbound) GetIps() []*OnlineIPEntry {
	if x != nil {
		return x.Ips
	}
	return nil
...
type GetOnlineUsersByInboundRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetOnlineUsersByInboundRequest) Reset() {
	*x = GetOnlineUsersByInboundRequest{}
	mi := &file_app_stats_command_command_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetOnlineUsersByInboundRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetOnlineUsersByInboundRequest) ProtoMessage() {}

func (x *GetOnlineUsersByInboundRequest) ProtoReflect() protoreflect.Message {
	mi := &file_app_stats_command_command_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetOnlineUsersByInboundRequest.ProtoReflect.Descriptor instead.
func (*GetOnlineUsersByInboundRequest) Descriptor() ([]byte, []int) {
	return file_app_stats_command_command_proto_rawDescGZIP(), []int{16}
}

type GetOnlineUsersByInboundResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Users         []*OnlineUserByInbound `protobuf:"bytes,1,rep,name=users,proto3" json:"users,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetOnlineUsersByInboundResponse) Reset() {
	*x = GetOnlineUsersByInboundResponse{}
	mi := &file_app_stats_command_command_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetOnlineUsersByInboundResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetOnlineUsersByInboundResponse) ProtoMessage() {}

func (x *GetOnlineUsersByInboundResponse) ProtoReflect() protoreflect.Message {
	mi := &file_app_stats_command_command_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetOnlineUsersByInboundResponse.ProtoReflect.Descriptor instead.
func (*GetOnlineUsersByInboundResponse) Descriptor() ([]byte, []int) {
	return file_app_stats_command_command_proto_rawDescGZIP(), []int{17}
}

func (x *GetOnlineUsersByInboundResponse) GetUsers() []*OnlineUserByInbound {
	if x != nil {
		return x.Users
	}
	return nil
...
const file_app_stats_command_command_proto_rawDesc = "" +
	...
	"\atraffic\x18\x03 \x01(\v2'.xray.app.stats.command.TrafficUserStatR\atraffic\"\x85\x01\n" +
	"\x13OnlineUserByInbound\x12\x1f\n" +
	"\vinbound_tag\x18\x01 \x01(\tR\n" +
	"inboundTag\x12\x14\n" +
	"\x05email\x18\x02 \x01(\tR\x05email\x127\n" +
	"\x03ips\x18\x03 \x03(\v2%.xray.app.stats.command.OnlineIPEntryR\x03ips\"U\n" +
	...
	"\x05users\x18\x01 \x03(\v2 .xray.app.stats.command.UserStatR\x05users\" \n" +
	"\x1eGetOnlineUsersByInboundRequest\"d\n" +
	"\x1fGetOnlineUsersByInboundResponse\x12A\n" +
	"\x05users\x18\x01 \x03(\v2+.xray.app.stats.command.OnlineUserByInboundR\x05users\"\b\n" +
	"\x06Config2\x95\a\n" +
	"\fStatsService\x12_\n" +
	...
	"\x17GetOnlineUsersByInbound\x126.xray.app.stats.command.GetOnlineUsersByInboundRequest\x1a7.xray.app.stats.command.GetOnlineUsersByInboundResponse\"\x00Bd\n" +
...
var file_app_stats_command_command_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_app_stats_command_command_proto_goTypes = []any{
	...
	(*OnlineUserByInbound)(nil),             // 13: xray.app.stats.command.OnlineUserByInbound
	(*GetUsersStatsRequest)(nil),            // 14: xray.app.stats.command.GetUsersStatsRequest
	(*GetUsersStatsResponse)(nil),           // 15: xray.app.stats.command.GetUsersStatsResponse
	(*GetOnlineUsersByInboundRequest)(nil),  // 16: xray.app.stats.command.GetOnlineUsersByInboundRequest
	(*GetOnlineUsersByInboundResponse)(nil), // 17: xray.app.stats.command.GetOnlineUsersByInboundResponse
	(*Config)(nil),                          // 18: xray.app.stats.command.Config
	nil,                                     // 19: xray.app.stats.command.GetStatsOnlineIpListResponse.IpsEntry
}
var file_app_stats_command_command_proto_depIdxs = []int32{
	...
	19, // 2: xray.app.stats.command.GetStatsOnlineIpListResponse.ips:type_name -> xray.app.stats.command.GetStatsOnlineIpListResponse.IpsEntry
	...
	10, // 5: xray.app.stats.command.OnlineUserByInbound.ips:type_name -> xray.app.stats.command.OnlineIPEntry
	12, // 6: xray.app.stats.command.GetUsersStatsResponse.users:type_name -> xray.app.stats.command.UserStat
	13, // 7: xray.app.stats.command.GetOnlineUsersByInboundResponse.users:type_name -> xray.app.stats.command.OnlineUserByInbound
	...
	14, // 14: xray.app.stats.command.StatsService.GetUsersStats:input_type -> xray.app.stats.command.GetUsersStatsRequest
	16, // 15: xray.app.stats.command.StatsService.GetOnlineUsersByInbound:input_type -> xray.app.stats.command.GetOnlineUsersByInboundRequest
	...
	15, // 22: xray.app.stats.command.StatsService.GetUsersStats:output_type -> xray.app.stats.command.GetUsersStatsResponse
	17, // 23: xray.app.stats.command.StatsService.GetOnlineUsersByInbound:output_type -> xray.app.stats.command.GetOnlineUsersByInboundResponse
