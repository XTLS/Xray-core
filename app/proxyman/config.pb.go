...
type SenderConfig struct {
	...
	ViaCidrs          []string               `protobuf:"bytes,5,rep,name=via_cidrs,json=viaCidrs,proto3" json:"via_cidrs,omitempty"`
}
...
func (x *SenderConfig) GetViaCidrs() []string {
	if x != nil {
		return x.ViaCidrs
	}
	return nil
...
var file_app_proxyman_config_proto_rawDesc = []byte{
	...
	0x75, 0x6e, 0x64, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0xcd, 0x02, 0x0a, 0x0c, 0x53, 0x65,
	...
	0x70, 0x6c, 0x65, 0x78, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x12, 0x1b, 0x0a, 0x09,
	0x76, 0x69, 0x61, 0x5f, 0x63, 0x69, 0x64, 0x72, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x09, 0x52,
	0x08, 0x76, 0x69, 0x61, 0x43, 0x69, 0x64, 0x72, 0x73, 0x22, 0xa4, 0x01, 0x0a, 0x12, 0x4d, 0x75,
