...
type Policy_Stats struct {
	...
	UplinkSpeedLimit   int64                  `protobuf:"varint,4,opt,name=uplink_speed_limit,json=uplinkSpeedLimit,proto3" json:"uplink_speed_limit,omitempty"`
	DownlinkSpeedLimit int64                  `protobuf:"varint,5,opt,name=downlink_speed_limit,json=downlinkSpeedLimit,proto3" json:"downlink_speed_limit,omitempty"`
	MaxConcurrentIps   int32                  `protobuf:"varint,6,opt,name=max_concurrent_ips,json=maxConcurrentIps,proto3" json:"max_concurrent_ips,omitempty"`
...
func (x *Policy_Stats) GetUplinkSpeedLimit() int64 {
	if x != nil {
		return x.UplinkSpeedLimit
	}
	return 0
}

func (x *Policy_Stats) GetDownlinkSpeedLimit() int64 {
	if x != nil {
		return x.DownlinkSpeedLimit
	}
	return 0
}

func (x *Policy_Stats) GetMaxConcurrentIps() int32 {
	if x != nil {
		return x.MaxConcurrentIps
	}
	return 0
}

func (x *Policy_Stats) GetBurstSize() int64 {
	if x != nil {
		return x.BurstSize
	}
	return 0
...
const file_app_policy_config_proto_rawDesc = "" +
	...
	"\x06Second\x12\x14\n" +
	"\x05value\x18\x01 \x01(\rR\x05value\"\xf5\x05\n" +
	"\x06Policy\x129\n" +
	...
	"uplinkOnly\x12<\n" +
	"\rdownlink_only\x18\x04 \x01(\v2\x17.xray.app.policy.SecondR\fdownlinkOnly\x1a\x9b\x02\n" +
	"\x05Stats\x12\x1f\n" +
	...
	"userOnline\x12,\n" +
	"\x12uplink_speed_limit\x18\x04 \x01(\x03R\x10uplinkSpeedLimit\x120\n" +
	"\x14downlink_speed_limit\x18\x05 \x01(\x03R\x12downlinkSpeedLimit\x12,\n" +
	"\x12max_concurrent_ips\x18\x06 \x01(\x05R\x10maxConcurrentIps\x12\x1d\n" +
	"\n" +
	"burst_size\x18\a \x01(\x03R\tburstSize\x1a(\n" +
	"\x06Buffer\x12\x1e\n" +
	"\n" +
