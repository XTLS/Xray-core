...
const (
	...
	ObservatoryService_ProbeOutboundStatus_FullMethodName = "/xray.core.app.observatory.command.ObservatoryService/ProbeOutboundStatus"
)
...
type ObservatoryServiceClient interface {
	...
	ProbeOutboundStatus(ctx context.Context, in *ProbeOutboundStatusRequest, opts ...grpc.CallOption) (*ProbeOutboundStatusResponse, error)
}
...
func (c *observatoryServiceClient) ProbeOutboundStatus(ctx context.Context, in *ProbeOutboundStatusRequest, opts ...grpc.CallOption) (*ProbeOutboundStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProbeOutboundStatusResponse)
	err := c.cc.Invoke(ctx, ObservatoryService_ProbeOutboundStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ObservatoryServiceServer interface {
	...
	ProbeOutboundStatus(context.Context, *ProbeOutboundStatusRequest) (*ProbeOutboundStatusResponse, error)
...
func (UnimplementedObservatoryServiceServer) ProbeOutboundStatus(context.Context, *ProbeOutboundStatusRequest) (*ProbeOutboundStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ProbeOutboundStatus not implemented")
}
...
func _ObservatoryService_ProbeOutboundStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProbeOutboundStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ObservatoryServiceServer).ProbeOutboundStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ObservatoryService_ProbeOutboundStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ObservatoryServiceServer).ProbeOutboundStatus(ctx, req.(*ProbeOutboundStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ObservatoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ProbeOutboundStatus",
			Handler:    _ObservatoryService_ProbeOutboundStatus_Handler,
		},
	},
