...
type QuicParams struct {
	...
	CongestionDebugLog      bool                   `protobuf:"varint,2,opt,name=congestion_debug_log,json=congestionDebugLog,proto3" json:"congestion_debug_log,omitempty"`
...
func (x *QuicParams) GetCongestionDebugLog() bool {
	if x != nil {
		return x.CongestionDebugLog
	}
	return false
}
...
const file_transport_internet_config_proto_rawDesc = "" +
	...
	"\finterval_max\x18\x03 \x01(\x03R\vintervalMax\"\x83\x05\n" +
	"\n" +
	"QuicParams\x12\x1e\n" +
	"\n" +
	"congestion\x18\x01 \x01(\tR\n" +
	"congestion\x120\n" +
	"\x14congestion_debug_log\x18\x02 \x01(\bR\x12congestionDebugLog\x12\x1b\n" +
