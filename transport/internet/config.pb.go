...
type SocketConfig struct {
	...
	TcpKeepAliveInterval       uint32         `protobuf:"varint,10,opt,name=tcp_keep_alive_interval,json=tcpKeepAliveInterval,proto3" json:"tcp_keep_alive_interval,omitempty"`
}
...
var file_transport_internet_config_proto_rawDesc = []byte{
	...
	0x65, 0x5f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0d,
