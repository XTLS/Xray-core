...
type DestinationStrategy int32

const (
	DestinationStrategy_None              DestinationStrategy = 0
	DestinationStrategy_SrvPortOnly       DestinationStrategy = 1
	DestinationStrategy_SrvAddressOnly    DestinationStrategy = 2
	DestinationStrategy_SrvPortAndAddress DestinationStrategy = 3
	DestinationStrategy_TxtPortOnly       DestinationStrategy = 4
	DestinationStrategy_TxtAddressOnly    DestinationStrategy = 5
	DestinationStrategy_TxtPortAndAddress DestinationStrategy = 6
)

// Enum value maps for DestinationStrategy.
var (
	DestinationStrategy_name = map[int32]string{
		0: "None",
		1: "SrvPortOnly",
		2: "SrvAddressOnly",
		3: "SrvPortAndAddress",
	...
	DestinationStrategy_value = map[string]int32{
		"None":              0,
		"SrvPortOnly":       1,
		"SrvAddressOnly":    2,
		"SrvPortAndAddress": 3,
...
func (x DestinationStrategy) Enum() *DestinationStrategy {
	p := new(DestinationStrategy)
	*p = x
	return p
}

func (x DestinationStrategy) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DestinationStrategy) Descriptor() protoreflect.EnumDescriptor {
	return file_transport_internet_config_proto_enumTypes[1].Descriptor()
}

func (DestinationStrategy) Type() protoreflect.EnumType {
	return &file_transport_internet_config_proto_enumTypes[1]
}

func (x DestinationStrategy) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DestinationStrategy.Descriptor instead.
func (DestinationStrategy) EnumDescriptor() ([]byte, []int) {
...
type SocketConfig struct {
	...
	DestinationStrategy        DestinationStrategy `protobuf:"varint,21,opt,name=destination_strategy,json=destinationStrategy,proto3,enum=xray.transport.internet.DestinationStrategy" json:"destination_strategy,omitempty"`
}
...
func (x *SocketConfig) GetDestinationStrategy() DestinationStrategy {
	if x != nil {
		return x.DestinationStrategy
	}
	return DestinationStrategy_None
}
...
var file_transport_internet_config_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0xfc, 0x07, 0x0a, 0x0c, 0x53, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x66,
	...
	0x0d, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x53, 0x6f, 0x63, 0x6b, 0x6f, 0x70, 0x74, 0x12, 0x5f,
	...
	0x74, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x2e, 0x44, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x53, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x52, 0x13, 0x64, 0x65, 0x73, 0x74,
	0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x22,
	...
	0x13, 0x44, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x72, 0x61,
...
var file_transport_internet_config_proto_goTypes = []any{
	...
	(DestinationStrategy)(0),     // 1: xray.transport.internet.DestinationStrategy
...
var file_transport_internet_config_proto_depIdxs = []int32{
	...
	1, // 8: xray.transport.internet.SocketConfig.destination_strategy:type_name -> xray.transport.internet.DestinationStrategy
