...
type QuicParams struct {
	...
	InitStreamReceiveWindow uint64                 `protobuf:"varint,4,opt,name=init_stream_receive_window,json=initStreamReceiveWindow,proto3" json:"init_stream_receive_window,omitempty"`
	MaxStreamReceiveWindow  uint64                 `protobuf:"varint,5,opt,name=max_stream_receive_window,json=maxStreamReceiveWindow,proto3" json:"max_stream_receive_window,omitempty"`
	InitConnReceiveWindow   uint64                 `protobuf:"varint,6,opt,name=init_conn_receive_window,json=initConnReceiveWindow,proto3" json:"init_conn_receive_window,omitempty"`
	MaxConnReceiveWindow    uint64                 `protobuf:"varint,7,opt,name=max_conn_receive_window,json=maxConnReceiveWindow,proto3" json:"max_conn_receive_window,omitempty"`
	MaxIdleTimeout          int64                  `protobuf:"varint,8,opt,name=max_idle_timeout,json=maxIdleTimeout,proto3" json:"max_idle_timeout,omitempty"`
	KeepAlivePeriod         int64                  `protobuf:"varint,9,opt,name=keep_alive_period,json=keepAlivePeriod,proto3" json:"keep_alive_period,omitempty"`
	DisablePathMtuDiscovery bool                   `protobuf:"varint,10,opt,name=disable_path_mtu_discovery,json=disablePathMtuDiscovery,proto3" json:"disable_path_mtu_discovery,omitempty"`
	MaxIncomingStreams      int64                  `protobuf:"varint,11,opt,name=max_incoming_streams,json=maxIncomingStreams,proto3" json:"max_incoming_streams,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
const file_transport_internet_config_proto_rawDesc = "" +
	...
	"quicParams\x12N\n" +
	"\x0fsocket_settings\x18\x06 \x01(\v2%.xray.transport.internet.SocketConfigR\x0esocketSettings\"\x97\x04\n" +
	"\n" +
	"QuicParams\x12\x1e\n" +
	"\n" +
	...
	"brutalDown\x12;\n" +
	"\x1ainit_stream_receive_window\x18\x04 \x01(\x04R\x17initStreamReceiveWindow\x129\n" +
	"\x19max_stream_receive_window\x18\x05 \x01(\x04R\x16maxStreamReceiveWindow\x127\n" +
	"\x18init_conn_receive_window\x18\x06 \x01(\x04R\x15initConnReceiveWindow\x125\n" +
	"\x17max_conn_receive_window\x18\a \x01(\x04R\x14maxConnReceiveWindow\x12(\n" +
	"\x10max_idle_timeout\x18\b \x01(\x03R\x0emaxIdleTimeout\x12*\n" +
	"\x11keep_alive_period\x18\t \x01(\x03R\x0fkeepAlivePeriod\x12;\n" +
	"\x1adisable_path_mtu_discovery\x18\n" +
	" \x01(\bR\x17disablePathMtuDiscovery\x120\n" +
	"\x14max_incoming_streams\x18\v \x01(\x03R\x12maxIncomingStreams\"Q\n" +
