...
const file_transport_internet_hysteria2_config_proto_rawDesc = "" +
	"\n" +
	")transport/internet/hysteria2/config.proto\x12!xray.transport.internet.hysteria2\"\xe1\x03\n" +
	"\x06Config\x12\x10\n" +
	"\x03udp\x18\x01 \x01(\bR\x03udp\x12\x12\n" +
	"\x04auth\x18\x02 \x01(\tR\x04auth\x12\x0e\n" +
	"\x02up\x18\x03 \x01(\x04R\x02up\x12\x12\n" +
	"\x04down\x18\x04 \x01(\x04R\x04down\x12\x12\n" +
	"\x04obfs\x18\x05 \x01(\tR\x04obfs\x12;\n" +
	...
	"\x1adisable_path_mtu_discovery\x18\f \x01(\bR\x17disablePathMtuDiscoveryB\x85\x01\n" +
