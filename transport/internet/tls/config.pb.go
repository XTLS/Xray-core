...
type Config struct {
	...
	CloseTimeout                         float32  `protobuf:"fixed32,16,opt,name=close_timeout,json=closeTimeout,proto3" json:"close_timeout,omitempty"`
}
...
var file_transport_internet_tls_config_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x02, 0x52, 0x0c, 0x63, 0x6c, 0x6f, 0x73, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75,
