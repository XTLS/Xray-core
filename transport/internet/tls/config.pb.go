...
type Config struct {
	...
	Fingerprint      []string `protobuf:"bytes,11,rep,name=fingerprint,proto3" json:"fingerprint,omitempty"`
...
var file_transport_internet_tls_config_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x0b, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0b, 0x66, 0x69, 0x6e, 0x67, 0x65, 0x72, 0x70,
