...
type Config struct {
	...
	// API token for acme(for now just cloudflare)
	AcmeToken string `protobuf:"bytes,16,opt,name=acme_token,json=acmeToken,proto3" json:"acme_token,omitempty"`
	// ACME Mail
	AcmeMail string `protobuf:"bytes,17,opt,name=acme_mail,json=acmeMail,proto3" json:"acme_mail,omitempty"`
}
...
func (x *Config) GetAcmeToken() string {
	if x != nil {
		return x.AcmeToken
	}
	return ""
...
func (x *Config) GetAcmeMail() string {
	if x != nil {
		return x.AcmeMail
	}
	return ""
...
var file_transport_internet_tls_config_proto_rawDesc = []byte{
	...
	0x49, 0x53, 0x53, 0x55, 0x45, 0x10, 0x02, 0x22, 0xb2, 0x06, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66,
	...
	0x12, 0x1d, 0x0a, 0x0a, 0x61, 0x63, 0x6d, 0x65, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x10,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x61, 0x63, 0x6d, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12,
	0x1b, 0x0a, 0x09, 0x61, 0x63, 0x6d, 0x65, 0x5f, 0x6d, 0x61, 0x69, 0x6c, 0x18, 0x11, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x08, 0x61, 0x63, 0x6d, 0x65, 0x4d, 0x61, 0x69, 0x6c, 0x42, 0x73, 0x0a, 0x1f,
