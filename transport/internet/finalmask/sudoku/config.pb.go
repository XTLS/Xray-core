...
const file_transport_internet_finalmask_sudoku_config_proto_rawDesc = "" +
	"\n" +
	"0transport/internet/finalmask/sudoku/config.proto\x12(xray.transport.internet.finalmask.sudoku\"\x9f\x01\n" +
	"\x06Config\x12\x1a\n" +
...
var (
	...
	file_transport_internet_finalmask_sudoku_config_proto_rawDescData = []byte(file_transport_internet_finalmask_sudoku_config_proto_rawDesc)
)
...
func file_transport_internet_finalmask_sudoku_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_transport_internet_finalmask_sudoku_config_proto_rawDescData,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
