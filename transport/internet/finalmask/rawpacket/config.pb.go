...
type Config struct {
	...
	// When empty, sni is used to auto-generate a TLS ClientHello.
	Payload string `protobuf:"bytes,1,opt,name=payload,proto3" json:"payload,omitempty"`
	// Fake SNI hostname for auto-generated ClientHello when payload is empty.
