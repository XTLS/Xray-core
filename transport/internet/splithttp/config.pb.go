...
type Config struct {
	...
	DisableXPadding      bool                   `protobuf:"varint,28,opt,name=disableXPadding,proto3" json:"disableXPadding,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *Config) GetDisableXPadding() bool {
	if x != nil {
		return x.DisableXPadding
	}
	return false
}
...
const file_transport_internet_splithttp_config_proto_rawDesc = "" +
	...
	"\x0fdisableXPadding\x18\x1c \x01(\bR\x0fdisableXPadding\x1a:\n" +
