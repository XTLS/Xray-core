...
type Config struct {
	...
	DownloadAddrPort     string                 `protobuf:"bytes,10,opt,name=downloadAddrPort,proto3" json:"downloadAddrPort,omitempty"`
	DownloadStreamConfig *internet.StreamConfig `protobuf:"bytes,11,opt,name=downloadStreamConfig,proto3" json:"downloadStreamConfig,omitempty"`
}
...
func (x *Config) GetDownloadAddrPort() string {
	if x != nil {
		return x.DownloadAddrPort
	}
	return ""
}

func (x *Config) GetDownloadStreamConfig() *internet.StreamConfig {
	if x != nil {
		return x.DownloadStreamConfig
	}
	return nil
}
...
var file_transport_internet_splithttp_config_proto_rawDesc = []byte{
	...
	0xb6, 0x06, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x12, 0x0a, 0x04, 0x68, 0x6f,
	...
	0x52, 0x04, 0x78, 0x6d, 0x75, 0x78, 0x12, 0x2a, 0x0a, 0x10, 0x64, 0x6f, 0x77, 0x6e, 0x6c, 0x6f,
	0x61, 0x64, 0x41, 0x64, 0x64, 0x72, 0x50, 0x6f, 0x72, 0x74, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x10, 0x64, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x41, 0x64, 0x64, 0x72, 0x50, 0x6f,
	0x72, 0x74, 0x12, 0x59, 0x0a, 0x14, 0x64, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x53, 0x74,
	0x72, 0x65, 0x61, 0x6d, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b,
	...
	0x6d, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x14, 0x64, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61,
	0x64, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x1a, 0x39, 0x0a,
...
var file_transport_internet_splithttp_config_proto_depIdxs = []int32{
	...
	4,  // 6: xray.transport.internet.splithttp.Config.downloadStreamConfig:type_name -> xray.transport.internet.StreamConfig
