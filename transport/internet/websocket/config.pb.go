...
type Fragmentation struct {
	...
	FragmentionIntervalTimeout int64  `protobuf:"varint,2,opt,name=fragmention_interval_timeout,json=fragmentionIntervalTimeout,proto3" json:"fragmention_interval_timeout,omitempty"`
...
func (x *Fragmentation) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Fragmentation) ProtoMessage() {}

func (x *Fragmentation) ProtoReflect() protoreflect.Message {
	mi := &file_transport_internet_websocket_config_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Fragmentation.ProtoReflect.Descriptor instead.
func (*Fragmentation) Descriptor() ([]byte, []int) {
	return file_transport_internet_websocket_config_proto_rawDescGZIP(), []int{1}
}

func (x *Fragmentation) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *Fragmentation) GetFragmentionIntervalTimeout() int64 {
	if x != nil {
		return x.FragmentionIntervalTimeout
	}
	return 0
}

func (x *Fragmentation) GetStrategy() string {
	if x != nil {
		return x.Strategy
	}
	return ""
...
func (x *Fragmentation) GetMaxChunkSize() int32 {
	if x != nil {
...
func (x *Fragmentation) GetSni() string {
	if x != nil {
		return x.Sni
	}
	return ""
...
type Config struct {
	...
	Fragmentation       *Fragmentation `protobuf:"bytes,6,opt,name=fragmentation,proto3" json:"fragmentation,omitempty"`
}

func (x *Config) Reset() {
	*x = Config{}
	if protoimpl.UnsafeEnabled {
		mi := &file_transport_internet_websocket_config_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Config) Descriptor() ([]byte, []int) {
	return file_transport_internet_websocket_config_proto_rawDescGZIP(), []int{2}
}
...
func (x *Config) GetFragmentation() *Fragmentation {
	if x != nil {
...
var file_transport_internet_websocket_config_proto_rawDesc = []byte{
	...
	,
	...
	0x6f, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x52, 0x06, 0x68, 0x65,
	0x61, 0x64, 0x65, 0x72, 0x12, 0x32, 0x0a, 0x15, 0x61, 0x63, 0x63, 0x65, 0x70, 0x74, 0x5f, 0x70,
	...
	0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x12, 0x0e, 0x0a, 0x02, 0x65, 0x64, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x02, 0x65, 0x64, 0x12, 0x56, 0x0a, 0x0d, 0x66, 0x72, 0x61, 0x67,
	...
	0x6b, 0x65, 0x74, 0x2e, 0x46, 0x72, 0x61, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x52, 0x0d, 0x66, 0x72, 0x61, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x4a, 0x04, 0x08, 0x01, 0x10, 0x02, 0x42, 0x85, 0x01, 0x0a, 0x25, 0x63, 0x6f, 0x6d, 0x2e, 0x78,
	0x72, 0x61, 0x79, 0x2e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x70, 0x6f, 0x72, 0x74, 0x2e, 0x69, 0x6e,
	0x74, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x2e, 0x77, 0x65, 0x62, 0x73, 0x6f, 0x63, 0x6b, 0x65, 0x74,
...
var file_transport_internet_websocket_config_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_transport_internet_websocket_config_proto_goTypes = []interface{}{
	...
	(*Fragmentation)(nil), // 1: xray.transport.internet.websocket.Fragmentation
	(*Config)(nil),        // 2: xray.transport.internet.websocket.Config
}
var file_transport_internet_websocket_config_proto_depIdxs = []int32{
	...
	1, // 1: xray.transport.internet.websocket.Config.fragmentation:type_name -> xray.transport.internet.websocket.Fragmentation
...
func file_transport_internet_websocket_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_transport_internet_websocket_config_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Config); i {
			case 0:
				return &v.state
			case 1:
