...
type Config struct {
	...
	Fingerprint  []string `protobuf:"bytes,21,rep,name=Fingerprint,proto3" json:"Fingerprint,omitempty"`
...
var file_transport_internet_reality_config_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x69, 0x6e, 0x74, 0x18, 0x15, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0b, 0x46, 0x69, 0x6e,
