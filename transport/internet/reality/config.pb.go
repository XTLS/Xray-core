...
type Config struct {
	...
	CloseTimeout float32  `protobuf:"fixed32,28,opt,name=close_timeout,json=closeTimeout,proto3" json:"close_timeout,omitempty"`
}
...
func (x *Config) GetCloseTimeout() float32 {
	if x != nil {
...
var file_transport_internet_reality_config_proto_rawDesc = []byte{
	...
	0x18, 0x1c, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0c, 0x63, 0x6c, 0x6f, 0x73, 0x65, 0x54, 0x69, 0x6d,
